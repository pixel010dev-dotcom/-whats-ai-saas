export default function DashboardHome() {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900">Vis\ão Geral</h1>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'Atendimentos hoje', value: '0', color: 'bg-blue-500' },
          { label: 'Clientes', value: '0', color: 'bg-green-500' },
          { label: 'Vendas do m\ês', value: 'R$ 0', color: 'bg-purple-500' },
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200">
        ...
        <p className="text-gray-400 text-center py-8">Conecte seu WhatsApp para come\çar a atender</p>
      </div>
    </div>
  )
}
