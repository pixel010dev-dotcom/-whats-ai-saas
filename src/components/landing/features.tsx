...
import { MessageCircle, Brain, BarChart3, Package, User, RefreshCw } from 'lucide-react'
...
export default function Features() {
  ...
  return (
    <section id="features" ref={ref} className="relative py-32 bg-zinc-950 overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-0 w-96 h-96 bg-emerald-500/5 rounded-full blur-[100px]" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group relative p-8 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover-card"
            >
